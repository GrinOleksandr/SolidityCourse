...
describe("Vendor", () => {
    ...
    beforeEach(async function () {
        ...
        const data = await vendorInstance.contract.methods.initialize(testTokenInstance.address, DAITokenInstance.address, nftTockenInstance.address, nftTokenId).encodeABI();

...
const daiTokenContractAddressKovan = '0x5592EC0cfb4dbc12D3aB100b257153436a1f0FEa';
...
module.exports = async function (deployer) {
  ...
  const data = await implementationInstance.contract.methods.initialize(
    sgrnTokenContractAddressKovan,
    daiTokenContractAddressKovan,
  );
  // .encodeABI();
